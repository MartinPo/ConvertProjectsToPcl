...
namespace ConvertToPcl_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(GuidList.guidConvertToPclCmdSet, (int)PkgCmdIDList.cmdidConvertToPcl);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ConvertToPcl", "VHQLabs.ConvertToPcl.ConvertToPclPackage");
