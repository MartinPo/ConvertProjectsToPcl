...
namespace MLabs.ConvertToPcl
{
    ...
    [Guid(GuidList.guidConvertToPclPkgString)]
    public sealed class ConvertToPclPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                pclConverter = new PclConverter(dte);
                ...
                {
                    synchronizationContext.Post(_ => pclConverter.OnBeforeSolutionLoaded(), null);
                };
                
                solutionLoadEvents.AfterSolutionLoaded += () =>
                {
                    synchronizationContext.Post(_ => pclConverter.OnAfterSolutionLoaded(), null);
                };


                // Create the command for the menu item.
                CommandID menuCommandID = new CommandID(GuidList.guidConvertToPclCmdSet, (int)PkgCmdIDList.cmdidConvertToPcl);
        ...
        private PclConverter pclConverter;
